...
def barh_on_benchmark_results(df, x_col, y_col="model_name", logx=False, color_col=None, cmap="tab20", figsize=(10,20)):
    """
    ...
    if color_col is not None:
        ...
        sdf.plot.barh(y_col, x_col, figsize=figsize, grid=True, logx=logx, 
                    color=[plt.cm.get_cmap(cmap)(colors[i]) for i in sdf[color_col]], ax=ax)
